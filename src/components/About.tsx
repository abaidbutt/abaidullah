    ...
    <section id="about" className="py-16 dark:bg-black dark:text-white bg-white text-black">
      <div className="container mx-auto p-3">
        <div className="text-center mb-12">
          <h2 className="md:text-4xl text-2xl font-extrabold mb-4">My Journey</h2>
        ...
        <div className="md:grid md:grid-cols-2 md:gap-8">
          <div className="space-y-6">
            ...
            >
              <p className="text-lg">
                As a full-stack developer, I am proficient with MERN Stack technologies, including React.js, Next.js, React Native, and Node.js. I efficiently manage APIs and data using Firebase, MongoDB, and MySQL.
              </p>
            </motion.div>
            ...
            >
              <p className="text-lg">
                I have expertise in integrating payment methods for subscriptions and invoices with Stripe. Additionally, I have experience with Docker, AWS EC2, auto-scaling with load balancers, and using GitHub Actions for CI/CD pipelines with ECR and ECS.
              </p>
            </motion.div>
          </div>
