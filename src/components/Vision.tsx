...
const VisionMission: React.FC = () => {
    return (
        <section id="vision-mission" className="py-10 bg-gray-100 text-gray-800">
            <div className="container mx-auto px-4">
                <div className="flex flex-col justify-around items-center">
                    <div className="text-center md:w-1/2 p-4">
                        <FaLightbulb className="text-4xl mx-auto mb-4 text-blue-500" />
                    ...
                    <div className="text-center p-4 w-full">
                        <ul className="flex flex-wrap justify-between items-stretch">
                            <li className="flex flex-col items-center w-full sm:w-1/2 lg:w-1/4 p-4">
                                <FaCogs className="text-5xl text-blue-500 mb-4" />
                            ...
                            <li className="flex flex-col items-center w-full sm:w-1/2 lg:w-1/4 p-4">
                                <FaChartLine className="text-5xl text-blue-500 mb-4" />
